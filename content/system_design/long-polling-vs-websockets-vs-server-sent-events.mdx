---
id: 2023-01-18-long-polling-vs-websockets-vs-server-sent-events
title: long polling vs websockets vs server sent events
metaTitle: Long Polling Vs Websockets Vs Server Sent Events | Anas's Digital Garden
metaDescription: long polling vs websockets vs server sent events | Anas's Digital Garden
createdDate: 2023-01-18
updatedDate: 2023-01-18
weekNumber: 202303
category: system_design
tags: ["system_design", "long-polling-vs-websockets-vs-server-sent-events"]
---
...
- The WebSocket protocol enables communication between a client and a server with lower overheads, facilitating real-time data transfer from and to the server. T
- his is made possible by providing a standardized way for the server to send content to the browser without being asked by the client and allowing for messages to be passed back and forth while keeping the connection open.
