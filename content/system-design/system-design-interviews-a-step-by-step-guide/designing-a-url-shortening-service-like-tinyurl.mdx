---
id: 2023-01-18-designing-a-url-shortening-service-like-tinyurl
title: designing a url shortening service like tinyurl
metaTitle: Designing a Url Shortening Service Like Tinyurl | Anas's Digital Garden
metaDescription: designing a url shortening service like tinyurl | Anas's Digital Garden
createdDate: 2023-01-18
updatedDate: 2023-01-18
weekNumber: 202303
category: system_design/system_design_interviews_a_step_by_step_guide
tags: ["system_design_interviews_a_step_by_step_guide", "designing-a-url-shortening-service-like-tinyurl"]
---
...
Similar services: [bit.ly](http://bit.ly/), [ow.ly](http://ow.ly/), [short.io](http://short.io/)  
...
We can compute a unique hash (e.g., [MD5](https://en.wikipedia.org/wiki/MD5) or [SHA256](https://en.wikipedia.org/wiki/SHA-2), etc.) of the given URL. The hash can then be encoded for display.

This encoding could be base36 ([a-z ,0-9]) or base62 ([A-Z, a-z, 0-9]) and if we add ‘+' and ‘/' we can use [Base64](https://en.wikipedia.org/wiki/Base64#Base64_table) encoding.
...
This approach can still lead to overloaded partitions, which can be solved using [Consistent Hashing](../consistent%20hashing.md).
...
![Untitled](designing%20a%20url%20shortening%20service%20like%20tiny-url/untitled%201.png)
