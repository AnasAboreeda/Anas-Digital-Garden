---
created: 2023-01-26T11:32:20 (UTC +01:00)
tags: [databases]
source: https://www.prisma.io/dataguide/intro/comparing-database-types
author: Justin Ellingwood
title: The Different Types of Databases - Overview with Examples
...
> ## Excerpt
> Many types of databases exist, each with their own benefits. In this guide, we compare the different types of databases and what each of them offer.
...
This section is dedicated to historic database types that aren't used much in modern development. You can [skip ahead to the section on relational databases](https://www.prisma.io/dataguide/intro/comparing-database-types#relational-databases-working-with-tables-as-a-standard-solution-to-organize-well-structured-data) if you aren't interested in that background.
...
[![Diagram of a hierarchical database](https://www.prisma.io/dataguide/content/intro/database-type-comparison/hierarchical.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/hierarchical.png)
...
[![Diagram of a network database](https://www.prisma.io/dataguide/content/intro/database-type-comparison/network.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/network.png)
...
[![Diagram of relational schema used to map entities for a school](https://www.prisma.io/dataguide/content/intro/database-type-comparison/relational.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/relational.png)
...
[![Diagram of key-value data store](https://www.prisma.io/dataguide/content/intro/database-type-comparison/key-value.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/key-value.png)
...
[![Diagram of document database](https://www.prisma.io/dataguide/content/intro/database-type-comparison/document.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/document.png)
...
[![Diagram of a graph database structure](https://www.prisma.io/dataguide/content/intro/database-type-comparison/graph.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/graph.png)
...
[![Diagram of column-family database structure](https://www.prisma.io/dataguide/content/intro/database-type-comparison/column.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/column.png)
...
[![Single metric time series databases](https://www.prisma.io/dataguide/content/intro/database-type-comparison/time-series-single-metric.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/time-series-single-metric.png)
...
[![Multi-metric time series databases](https://www.prisma.io/dataguide/content/intro/database-type-comparison/time-series-multi-metric.png)](https://www.prisma.io/dataguide/content/intro/database-type-comparison/time-series-multi-metric.png)
...
- **Semantic RDF graph databases:** Semantic RDF graph databases are databases that map objects using the Resource Description Framework. This framework a way to describe, in detail, objects and their relationships by categorizing pieces of data and connections. The idea is to map subjects, actions, and objects like you would in a sentence (for example, "Bill calls Sue"). For most use cases, labeled property graphs, usually just called [graph databases](https://www.prisma.io/dataguide/intro/comparing-database-types#graph-databases-mapping-relationships-by-focusing-on-how-connections-between-data-are-meaningful), can express relationships more flexibly and concisely.
