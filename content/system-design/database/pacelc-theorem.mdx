---
id: 2023-01-18-pacelc-theorem
title: Pacelc Theorem
metaTitle: Pacelc Theorem | Anas's Digital Garden
metaDescription: pacelc theorem | Anas's Digital Garden
createdDate: 2023-01-18
updatedDate: 2023-01-27
weekNumber: 202303
category: system_design
tags: ["system_design", "pacelc-theorem"]
---
...
![](../attachements/pacelc-theorem/untitled.png)

- The first part of the theorem (**PAC**) is the same as the CAP theorem, and the **ELC** is the extension.
- The whole thesis is assuming we maintain high availability by replication. So, when there is a failure, CAP theorem prevails.
