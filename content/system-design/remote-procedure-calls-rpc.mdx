---
id: 2023-01-21-remote-procedure-calls-rpc
title: Remote Procedure Calls - RPC
metaTitle: Remote Procedure Calls Rpc | Anas's Digital Garden
metaDescription: remote procedure calls rpc | Anas's Digital Garden
createdDate: 2023-01-21
updatedDate: 2023-01-26
weekNumber: 202303
category: garden/system-design
tags: ["system-design", "remote-procedure-calls-rpc", "abstraction", "rpc"]
---
...
![The components of an RPC system](attachements/remote-procedure-calls/remote-procedure-calls.jpg)
...
4. RPC runtime at the server receives the message and passes it to the server stub.
	1. **Note:** The RPC runtime is responsible for transmitting messages between client and server via the network. The responsibilities of RPC runtime also include retransmission, acknowledgment, and encryption.
...
![The workflow of an RPC](attachements/remote-procedure-calls/remote-procedure-calls-2.jpg)
