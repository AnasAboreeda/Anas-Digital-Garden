---
id: 2023-01-22-back-of-the-envelope-calculations
title: Back of the Envelope Calculations
metaTitle: Back Of The Envelope Calculations | Anas's Digital Garden
metaDescription: back of the envelope calculations | Anas's Digital Garden
createdDate: Sunday, January 22nd 2023
updatedDate: Wednesday, January 25th 2023
weekNumber: 202304
category: system-design
tags: ["system-design", "back-of-the-envelope-calculations"]
aliases: [Back of the Envelope Calculations]
linter-yaml-title-alias: Back of the Envelope Calculations
---
...
![](attachements/back-of-the-envelope-calculations/back-of-the-envelope-calculations.jpg)
...
$RPS_{CPU}=Num_{CPU} X \frac{1}{Task_{time}}$
...
$RPS_{memory} = \frac{RAM_{size}}{Worker_{memory}} * \frac{1}{task time}$

In this calculation, we use these terms:

$RPS_{memory}$   : Memory bound RPS
$RAM_{size}$   :Total size of RAM
$Worker_{memory}$   : Total size of RAM

$RPS_{memory} = \frac{240GB}{300MB} X \frac{1}{50ms} = 16,000 RPS$
...
$\frac{360}{2} + \frac{16,000}{2} = 8,180 \approx ~8,000$
...
| Total requests / second   |  115 | K       | $\frac{500M \times 20}{86400} = 115K$|
| Total servers required    |  15  |         | $\frac{Number\ of\ Requests/sec}{RPS\ of\ server} = \frac{115K}{8k} \approx 15$|
...
| Daily tweets               | 3      |    |
| Total requests / day       |  750   | M  ||
| Storage required per tweet | 250    | B  |
| Storage required per image | 200    | KB |
| Storage required per video | 3      | MB |
| Storage for tweets         |  187.5 | GB |$750 \times 10^6 \times 250 B= 187.5\ GB$|
| Storage for images         |  15    | TB | $\frac{750 \times 10^6 \times 10}{100} \times 200 \times 10^3 B= 15\ TB$|
| Storage for videos         |  112.5 | TB |$\frac{750 \times 10^6 \times 5}{100} \times 3 \times 10^6 B= 112.5\ TB$|
