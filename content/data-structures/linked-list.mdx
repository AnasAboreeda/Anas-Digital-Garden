...
![Singly-linked list Time Complexity](./linked-list/singly-linked-list-time-complexity.png)

### Doubly-linked Lists time Complexity

![Doubly-Linked list Time Complexity](./linked-list/doubly-linked-list-time-complexity.png)
