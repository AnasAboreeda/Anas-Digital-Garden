---
id: 2017-11-16-networking-concepts
...
- Simple Network Management Protocol (SNMP)-Used as a management tool to query network- and server-based devices for
